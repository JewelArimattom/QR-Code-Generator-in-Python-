...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jewel\Desktop\Project\Python\QR Code'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jewel\Desktop\Project\Python\QR Code\Scripts\deactivate.nu'
